...
# File: backend/job_ingestion/app/services/email_ingestion.py

import logging

from job_ingestion.app.extraction.email.email_alert_fetcher import EmailAlertFetcher
from job_ingestion.app.extraction.email.job_extraction_service import (
    JobExtractionService,
)
from job_ingestion.app.schemas.extracted_jobs import JobPostingResponse
