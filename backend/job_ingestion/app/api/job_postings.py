...
# File: backend/job_ingestion/app/api/job_postings.py

from typing import Annotated

from fastapi import APIRouter, Depends, HTTPException
from job_ingestion.app.core.config import Settings, get_settings
from job_ingestion.app.schemas.extracted_jobs import IngestResponse
from job_ingestion.app.services.django_client import DjangoIngestionClient
from job_ingestion.app.services.email_ingestion import JobIngestionService
