...
# File: backend/job_ingestion/testdata/generators/fixtures.py

from job_ingestion.app.core.config import Settings
from job_ingestion.app.extraction.email.email_alert_fetcher import (
    EmailAlertFetcher,
    FetchedEmail,
)
from job_ingestion.app.extraction.email.parser_base import EmailParser
from job_ingestion.testdata.fixtures.writer import create_fixture, remove_all_fixtures
