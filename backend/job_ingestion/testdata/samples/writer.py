...
# File: backend/job_ingestion/testdata/samples/writer.py
...
from job_ingestion.app.core.config import Settings
from job_ingestion.app.normalization.headers.pii import redact_headers
from job_ingestion.app.normalization.headers.whitelist import whitelist_headers
from job_ingestion.app.normalization.html.pii import redact_pii
from job_ingestion.app.normalization.html.structural import strip_structure
from job_ingestion.app.normalization.pii.patterns import (
    build_email_pattern,
    build_name_pattern,
)
from job_ingestion.app.normalization.url.sanitize import sanitize_job_url
from job_ingestion.testdata.fixtures.naming import format_fixture_date
