...
# File: backend/job_ingestion/scripts/generate_fixtures.py

import logging

from job_ingestion.app.core.config import Settings, get_settings
from job_ingestion.app.extraction.email.email_alert_fetcher import EmailAlertFetcher
from job_ingestion.app.extraction.email.parser_base import EmailParser
from job_ingestion.app.extraction.email.parsers.indeed import IndeedParser
from job_ingestion.app.extraction.email.parsers.linkedin import LinkedInParser
from job_ingestion.testdata.generators.fixtures import FixtureGenerator
